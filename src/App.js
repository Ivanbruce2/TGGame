...
function App() {
  ...
  const fetchRooms = async () => {
    try {
      const response = await fetch(`https://d6272dfcffc8692b5f52f409a130acf2.serveo.net/list_rooms`, {
        headers: {}
      });
  ...
  const initializeUser = async (userID, username) => {
    try {
      const response = await fetch('https://d6272dfcffc8692b5f52f409a130acf2.serveo.net/initialize_user', {
        method: 'POST',
        headers: {
    ...
    try {
      ...
      const pollGameStatus = async () => {
        try {
          ...
          const response = await fetch(`https://d6272dfcffc8692b5f52f409a130acf2.serveo.net/game_status?room_id=${roomId}`, {
            headers: {}
          });
  ...
  const createRoom = async () => {
    ...
    try {
      const response = await fetch('https://d6272dfcffc8692b5f52f409a130acf2.serveo.net/create_room', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded',
        },
  ...
  const joinRoom = async (roomId) => {
    try {
      const response = await fetch('https://d6272dfcffc8692b5f52f409a130acf2.serveo.net/join_room', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded',
        },
  ...
  const handleChoice = async (choice) => {
    ...
    try {
      const response = await fetch('https://d6272dfcffc8692b5f52f409a130acf2.serveo.net/webhook', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded',
        },
  ...
  const leaveGame = async () => {
    if (selectedRoom) {
      ...
      console.log(userID);
      await fetch('https://d6272dfcffc8692b5f52f409a130acf2.serveo.net/leave_room', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded',
        },
